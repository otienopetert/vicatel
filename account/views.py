...
def signup(request):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			mail = EmailMessage('VICTORIA COMPUTERS AND TELECOMS LTD - Account Confirmation mail', message, to=[user.email], from_email=settings.EMAIL_HOST_USER, fail_silently=True)
